          ...
          {menuOpen && (
            <div className="md:hidden">
              <div className="space-y-0.5 px-2 pt-1 pb-2">
                <a href="#" className="text-white hover:bg-teal-400 hover:bg-opacity-20 block px-3 py-1 rounded-md text-sm">Home</a>
                <a href="#" className="text-white hover:bg-teal-400 hover:bg-opacity-20 block px-3 py-1 rounded-md text-sm">Features</a>
                <a href="#" className="text-white hover:bg-teal-400 hover:bg-opacity-20 block px-3 py-1 rounded-md text-sm">Pricing</a>
                <a href="#" className="text-white hover:bg-teal-400 hover:bg-opacity-20 block px-3 py-1 rounded-md text-sm">Support</a>
              </div>
            </div>
          )}
        </header>
