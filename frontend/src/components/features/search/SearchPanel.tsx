...
export const SearchPanel = () => {
  ...
  const searchMutation = useMutation({
    mutationFn: (query: string) => searchTranscription(query, useSemanticSearch),
    onError: (error) => {
  ...
  return (
    <div className="card">
      <div className="card-header">
        <h3 className="text-lg font-medium text-gray-900">Search Transcription</h3>
      </div>
      ...
      <div className="card-body">
          ...
          <div>
            <div className="flex flex-col gap-2">
              ...
              <button
                ...
                className="w-full btn-primary py-2.5 bg-blue-500 text-white rounded-md hover:bg-blue-600 transition-colors"
              >
          ...
          <div className="mt-6 max-h-[300px] overflow-y-auto pr-1">
            ...
            {searchMutation.data.matches.length > 0 ? (
              ...
              <div className="py-8 text-center">
                ...
                <p className="mt-1 text-sm text-gray-500">Try adjusting your search terms or use semantic search.</p>
              </div>
            )}
          </div>
        )}
        ...
        {searchMutation.isError && (
          <div className="mt-4 p-3 bg-red-50 border-l-4 border-red-400 text-red-700 text-sm rounded-md">
            An error occurred during search. Please try again with different search terms.
          </div>
        )}
      </div>
    </div>
