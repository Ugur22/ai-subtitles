...
export const SubtitleControls = ({ filename, videoHash }: SubtitleControlsProps) => {
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-2">
      ...
      >
        {downloading === "original" ? <><SpinnerIcon />Downloading...</> : <><DownloadIcon />Original Subtitles</>}
      </button>
      ...
      >
        {downloading === "english" ? <><SpinnerIcon />Downloading...</> : <><DownloadIcon />English Subtitles</>}
      </button>
    </div>
  );
};
